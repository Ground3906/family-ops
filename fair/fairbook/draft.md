...
A first violation results in a written warning. A second violation results in forfeiture of all premiums for the current show. A third violation disqualifies the exhibitor from the show. Violations are cumulative across all species and all years per CC 2.7(a). A violation that also constitutes a violation of the IAFE Code of Show Ring Ethics results in forfeiture of premiums, awards, and auction proceeds for all affected classes.
...
(a) Every warning and every penalty is permanent. It is recorded and counts for as long as that person takes part in Custer County 4-H or FFA. No warning expires and no record is cleared.
...
(c) Warnings and penalties count across every project and every species.

(d) A prior record informs the Authority. It does not by itself determine the outcome of any new matter.
...
The following dress standard applies to any exhibitor while in front of a judge in a livestock or animal show. This standard is in addition to the grounds dress standard in CC 2.4. Departments may carry their own ring dress deviation; that deviation applies in that department.

Long sleeves are required. Nice jeans are required. Closed-toe shoes are required. No sandals. No hats while showing. No gum or tobacco while showing.
