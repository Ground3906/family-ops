"""
Generator: D-1 - Birdsmouth at Beam, South Bearing Detail
Format matched to S-4 / S-5: black-and-white line drawing, members drawn as
...
text(40, TB_Y + 34, "SCALE:  3\" = 1'-0\"          DRAWING D-1", 12)
...
gen = [
    ...
    "   CAP PLATE, FULL WIDTH, NO NOTCH - SEE S-4.",
...
with open('/home/claude/greenhouse/D-1-birdsmouth-detail.svg', 'w') as fh:
    fh.write("\n".join(s))
