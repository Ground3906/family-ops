"""
Generator: D-2 - South Roof Edge and Bearing, Crosscut Detail
...
Format matched to S-4 / S-5: black and white, true-scale members, dimension
...
text(40, TB_Y + 34, "SCALE:  3\" = 1'-0\"          DRAWING D-2", 12)
...
notebox(40, 660, "GENERAL NOTES", [
    ...
    "PHASE 1 IS METAL. NO ROOF SHEATHING SOUTH OF THE 9'-7 1/4\" LINE. SEE S-5.",
...
s.append('</svg>')
open('/home/claude/greenhouse/D-2-south-roof-edge-detail.svg', 'w').write("\n".join(s))
