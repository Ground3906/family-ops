"""
Generator: S-5 - Greenhouse Roof Framing Plan
Format matched to S-4 / S-2 / S-3: black-and-white line drawing, members drawn
...
# ---------------------------------------------------------------
# SHEET SETUP - matches S-4 conventions
# ---------------------------------------------------------------
SCALE = 3.0               # px per inch, same as S-4
...
text(40, TB_Y + 34, "SCALE:  1/2\" = 1'-0\"          DRAWING S-5", 12)
...
gen = [
    "1. RAFTER FRAMING ONLY. PANEL LAYOUT ON D-3.",
    ...
    "5. NORTH RISER STUDS REMAIN 16\" O.C. - SEE S-4.",
...
with open('/home/claude/greenhouse/S-5-roof-framing-plan.svg', 'w') as fh:
    fh.write("\n".join(s))
