"""
Generator: D-3 - Roof Panel Layout (Phase 1 metal)
Reproduces the committed D-3 sheet. The ONLY design change from the version at
45f6e39 is the rafter layout: 31 at 16" o.c. becomes 21 at 24" o.c. to match S-5.
Sheet format, colours, panel runs, chalk line and title block are unchanged -
this sheet's look is not being reworked.
Source: farm/greenhouse-design-sheet.md and S-5.
...
s.append('  <text x="1035" y="195" font-size="11" fill="#333" text-anchor="end">to the wall face &#8212; see S-5</text>')
...
s.append('')
s.append('  <text x="550" y="470" font-size="12" font-weight="bold" fill="#1a1a1a" text-anchor="middle">overlap &#8212; see Detail D-5</text>')
s.append('')
...
s.append('  <text x="60" y="808" font-size="13" fill="#333">3. Install upper panels to measurements (4" overhang, lap per Detail D-5)</text>')
...
s.append('<text x="600" y="788" font-family="Arial" font-size="11" fill="#000">SCALE:  NOT TO SCALE       DRAWING D-3</text>')
s.append('</svg>')

open('/home/claude/greenhouse/D-3-panel-layout.svg', 'w').write("\n".join(s))
print("SVG written.")
