...
Built-up fill platform, roughly 6 ft proud of surrounding grade. Ground rises east, falls away south and west. Wheel-packed in lifts with the Gehl approximately 2023, three freeze-thaw cycles since. Not a tested Proctor number.
...
40 ft high cube, forms the **north wall**. Runs east to west. Cargo doors at the west end. Interior height 9 ft 6 in.
...
Container sits on dirt. Any excavation along its south face risks undermining corner-casting bearing.

Bird run is handled outside this design. Not a variable.
...
### Item 7 - Floor
No floor drop. Building sits on the pad as-is. Earth-tempering (walipini logic) does not apply: a fill berm standing proud is not stable ground.
...
1. **Slope crest setback.** Footing set 2-3 ft back from the slope break, minimum. A footing too near the crest shears the wedge out from under itself.
...
| Condition | Minimum pitch |
|-----------|---------------|
| Heated poly | 20-22 deg |
| Unheated poly | 28-30 deg |
...
**Modine HD100AS0111** (see `farm/garage-barn-build-sheet.md` for full spec and parts status). Serial 39010017094211-4531. Acquired 2026-08-02, $100.

| | |
|---|---|
| Input | 100,000 BTU/hr |
| Output at sea level | 82,000 BTU/hr (82% eff) |
| **Delivered at 9,000 ft** | **~52,000 BTU/hr** (36% derate) |
| Vent | 4 in horizontal Cat III, locked |
| Power | 115V / 4.7A |
